...
label_exam_raw = tk.Label(root, text="未設定") # 非表示データ保持用
...
# --- Tab 1: やること ---
tk.Label(tab1, text="試験までにやるべきこと:").pack(pady=5)
...
label_prob_path = tk.Label(tab2, text="未選択", fg="blue"); label_prob_path.pack()
...
# 【重要】すべての画面パーツ(Listboxなど)を作り終えた後に、データを読み込む
load_data()
